...
### 🔔 **Smart Notifications**
- **Multiple Channels**: Email (SMTP), Slack, Telegram, Webhooks, Ntfy
...
The fastest way to get started with Peekaping is using Docker:
...
- **[Getting Started](/tutorial-basics/create-a-document)** - Quick setup and basic usage
- **[Self-hosting](/self-hosting/docker)** - Complete installation guides
- **[User Guide](/tutorial-basics/create-a-page)** - Detailed feature explanations
- **[Configuration](/tutorial-extras/manage-docs-versions)** - Environment and settings reference
...
Ready to start monitoring? [Get started with Docker](/self-hosting/docker) or explore the [tutorial](/tutorial-basics/create-a-document)!
